...
def select_series_title_with_most_human_characters
    ...
    # JOIN character_books ON characters._id = series.id
    # GROUP BY chracters.species, 
    # HAVING chracters.species = 'human';"
    "SELECT series.title FROM series 
    ...
    WHERE characters.species = 'human' GROUP BY series.title ORDER BY COUNT(series.title) DESC LIMIT 1"
end
